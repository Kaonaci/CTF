...
**Запрос в Burp Suite:**
```http
POST /api/chats/5ce14d4e-70cf-41a9-9bd4-6c8a392fc4ab/join HTTP/1.1
...
> *"Ваша заявка на участие в походе рассмотрена. К сожалению, все места уже заняты"*.

Сразу после этого нас исключают из чата. В HTTP-трафике больше ничего не происходит, флаг не приходит, что бы мы не мутили в http.
